...
// info begin
// Generated by script 2014-08-15 13:31:34, 
// based on file "C:\Dropbox\Deling\Nema\Supporting tables version 1.14.xlsx".
// info end
...
$user32 = User::create(array(
	...
	'job_position_name' => "Environment Monitoring Officer" ,
...
$user33 = User::create(array(
	'initials' => "bikanut" ,
	'full_name' => "Bernard Michael Ikanut" ,
	'job_position_code' => "EMO" ,
	'job_position_name' => "Environment Monitoring Officer" ,
	'email' => "bikanut@nemaug.org" ,
	'password' => Hash::make('michael')            
));

$user34 = User::create(array(
	'initials' => "akasekende" ,
	'full_name' => "Aristarco Kasekende" ,
	'job_position_code' => "DFA" ,
	'job_position_name' => "Director Finance and Administration" ,
	'email' => "akasekende@nemaug.org" ,
	'password' => Hash::make('aristarco')            
));

$user35 = User::create(array(
	'initials' => "akasagga" ,
	'full_name' => "Allan Kasagga" ,
	'job_position_code' => "CA " ,
	'job_position_name' => "Chief Accountant" ,
	'email' => "akasagga@nemaug.org" ,
	'password' => Hash::make('allan')            
));

$user36 = User::create(array(
	'initials' => "fnampeera" ,
	'full_name' => "Florence Nampeera" ,
	'job_position_code' => "AC" ,
	'job_position_name' => "Accountant" ,
	'email' => "fnampeera@nemaug.org" ,
	'password' => Hash::make('florence')            
));

$user37 = User::create(array(
	'initials' => "saiik" ,
	'full_name' => "Shirley Aiik" ,
	'job_position_code' => "AA" ,
	'job_position_name' => "Accountants Assistant" ,
	'email' => "saiik@nemaug.org" ,
	'password' => Hash::make('shirley')            
));
...
$user2->attachRole($role1);
$user2->attachRole($role5);

$user5->attachRole($role3);

$user6->attachRole($role3);

$user9->attachRole($role3);

$user11->attachRole($role3);

$user12->attachRole($role6);

$user13->attachRole($role1);

$user14->attachRole($role5);

$user16->attachRole($role1);
$user16->attachRole($role2);
$user16->attachRole($role3);

$user17->attachRole($role1);

$user19->attachRole($role3);

$user20->attachRole($role1);
$user20->attachRole($role2);
$user20->attachRole($role3);
$user20->attachRole($role4);
$user20->attachRole($role5);
$user20->attachRole($role6);
$user20->attachRole($role7);
$user20->attachRole($role8);

$user21->attachRole($role3);

$user22->attachRole($role5);

$user23->attachRole($role3);

$user25->attachRole($role2);
$user25->attachRole($role3);

$user26->attachRole($role1);
$user26->attachRole($role2);
$user26->attachRole($role3);
$user26->attachRole($role4);
$user26->attachRole($role5);
$user26->attachRole($role6);
$user26->attachRole($role7);
$user26->attachRole($role8);

$user27->attachRole($role1);
$user27->attachRole($role2);
$user27->attachRole($role3);
$user27->attachRole($role4);
$user27->attachRole($role5);
$user27->attachRole($role6);
$user27->attachRole($role7);
$user27->attachRole($role8);
...
$user31->attachRole($role3);

$user32->attachRole($role3);

$user33->attachRole($role3);

$user34->attachRole($role4);

$user35->attachRole($role4);

$user36->attachRole($role4);

$user37->attachRole($role4);

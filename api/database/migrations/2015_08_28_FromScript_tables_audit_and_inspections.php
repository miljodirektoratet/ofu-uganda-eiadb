...
// info begin
// Generated by script 2015-09-15 10:07:41, 
// based on file "N:\Felles\Forurensning\2. Internasjonalt arbeid\2012. Uganda\Kravspek\Tabeller\Databasefields for EIA database NEMA version 0.54.xlsx".
// info end
...
Schema::create('audits_inspections_documentation', function(Blueprint $table)
{
	$table->increments('id');
	$table->integer('audit_inspection_id')->unsigned()->nullable(); 
	$table->foreign('audit_inspection_id')->references('id')->on('audits_inspections');
...
// down begin
	...
	Schema::dropIfExists('audits_inspections_documentation', function(Blueprint $table){});
// down end
	DB::statement('SET FOREIGN_KEY_CHECKS=1;');
	}

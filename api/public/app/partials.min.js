angular.module('seroApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('partials/statisticsProjects.html',
    "<div class=statistics-projects><div class=row ng-show=isLoadingData><div class=col-md-12><div class=\"loader-standalone center-block\"></div></div></div><div ng-show=!isLoadingData><p class=lead>{{data.intro.title}}</p><div class=row><div class=col-md-6><div class=row><div class=col-md-12><statistics-panel part=data.parts.categoryEiaYes></statistics-panel></div></div><div class=row><div class=col-md-12><statistics-panel part=data.parts.categoryEiaNo></statistics-panel></div></div></div><div class=col-md-6><div class=row><div class=col-md-12><statistics-panel part=data.parts.coordinates></statistics-panel></div></div><div class=row><div class=col-md-12><statistics-panel part=data.parts.wasteWater></statistics-panel></div></div><div class=row><div class=col-md-12><statistics-panel part=data.parts.grades></statistics-panel></div></div><div class=row><div class=col-md-12><statistics-panel part=data.parts.developers></statistics-panel></div></div></div></div></div><div class=row><div class=col-md-12><hr></div></div><div class=row ng-show=isLoadingResultGrid><div class=col-md-12><div class=\"loader-standalone center-block\"></div></div></div><div class=row ng-show=showResultGrid><div class=col-md-12><div ui-grid=gridOptions ui-grid-resize-columns ui-grid-move-columns class=result-grid></div></div></div></div>"
  );

angular.module('seroApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('partials/advancedEmailOrder.html',
    "<div class=top-header><h1>Advanced</h1></div><div class=advanced><div class=row><div class=col-md-8>Email Orders</div><div class=col-md-4></div></div><div class=row><div class=col-md-12><hr></div></div><div ui-grid=gridOptions ui-grid-edit ui-grid-row-edit ui-grid-cellnav ui-grid-resize-columns ui-grid-move-columns class=grid></div></div>"
  );

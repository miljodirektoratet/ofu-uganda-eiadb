angular.module('seroApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('partials/searchAuditsInspections.html',
    "<div class=search-auditsandinspections><div class=row><div class=col-md-12><form ng-submit=setSearchUrl()><div class=row><div class=col-md-3><div class=form-group><label for=project_title>Project title</label><input class=\"form-control input-sm\" id=project_title ng-model=criteria.project_title set-focus></div></div></div><div class=row><div class=col-md-3><div class=form-group><label for=auditinspection_year>Year</label><input class=\"form-control input-sm\" id=auditinspection_year ng-model=\"criteria.auditinspection_year\"></div></div></div><div class=row><div class=col-md-3><div class=form-group><label for=auditinspection_action_taken>Action taken</label><select ui-select2={allowClear:true} ng-required=false id=auditinspection_action_taken class=\"form-control input-sm\" ng-model=criteria.auditinspection_action_taken><option></option><option ng-repeat=\"v in valuelists.actiontaken\" value={{v.id}}>{{v.description1}}</option></select></div></div><div class=row><div class=col-md-12><button type=submit class=\"btn btn-primary\">Search</button> <button type=button class=\"btn btn-link\" ng-click=reset()>Reset search criteria</button></div></div></div></form></div></div><div class=row><div class=col-md-12><hr></div></div><div class=row ng-show=isSearching><div class=col-md-12><div class=\"loader-standalone center-block\"></div></div></div><div class=row ng-show=showResultGrid><div class=col-md-12><div ui-grid=gridOptions ui-grid-resize-columns ui-grid-move-columns class=result-grid></div></div></div></div>"
  );
  ...
  $templateCache.put('partials/statisticsProjects.html',
    "<div class=statistics-projects><div class=row ng-show=isLoadingData><div class=col-md-12><div class=\"loader-standalone center-block\"></div></div></div><div ng-show=!isLoadingData><p class=lead>The EIA database has {{data.counts.projects}} projects and {{data.counts.developers}} developers.<br>The statistics below shows the number of projects for some key elements.</p><div class=row><div class=col-md-6><div class=row><div class=col-md-12><div class=\"panel panel-default\"><div class=panel-heading><h2 class=panel-title>The number of projects per category, where the category is \"considered for EIA\".</h2></div><div class=panel-body><table class=\"table table-condensed\"><thead><tr><th>Category</th><th><div class=text-right>Number</div></th></tr></thead><tbody><tr ng-repeat=\"row in data.categoryEiaYes\"><td title={{row.id}}>{{row.description}}</td><td><div class=text-right>{{row.count}}</div></td></tr></tbody></table></div></div></div></div><div class=row><div class=col-md-12><div class=\"panel panel-default\"><div class=panel-heading><h2 class=panel-title>The number of projects per category, where the category is likely exempted from EIA.</h2></div><div class=panel-body><table class=\"table table-condensed\"><thead><tr><th>Category</th><th><div class=text-right>Number</div></th></tr></thead><tbody><tr ng-repeat=\"row in data.categoryEiaNo\"><td title={{row.id}}>{{row.description}}</td><td><div class=text-right>{{row.count}}</div></td></tr></tbody></table></div></div></div></div><div class=row><div class=col-md-12><div class=\"panel panel-default\"><div class=panel-heading><h2 class=panel-title>The number of projects with and without coordinates.</h2></div><div class=panel-body><div class=row><div class=col-md-6>Data</div><div class=col-md-6></div></div></div></div></div></div></div><div class=col-md-6><div class=row><div class=col-md-12><div class=\"panel panel-default\"><div class=panel-heading><h2 class=panel-title>The number of projects with and without industrial waste water.</h2></div><div class=panel-body><div class=row><div class=col-md-6>Data</div><div class=col-md-6></div></div></div></div></div></div><div class=row><div class=col-md-12><div class=\"panel panel-default\"><div class=panel-heading><h2 class=panel-title>The number of projects per developer. The list will show the ten developers with most number of projects.</h2></div><div class=panel-body><div class=row><div class=col-md-6>Data</div><div class=col-md-6></div></div></div></div></div></div><div class=row><div class=col-md-12><div class=\"panel panel-default\"><div class=panel-heading><h2 class=panel-title>The number of projects per grade.</h2></div><div class=panel-body><div class=row><div class=col-md-6>Data</div><div class=col-md-6></div></div></div></div></div></div></div></div></div><div class=row><div class=col-md-12><hr></div></div><div class=row ng-show=isLoadingResultGrid><div class=col-md-12><div class=\"loader-standalone center-block\"></div></div></div><div class=row ng-show=showResultGrid><div class=col-md-12><div ui-grid=gridOptions ui-grid-resize-columns ui-grid-move-columns class=result-grid></div></div></div></div>"
  );

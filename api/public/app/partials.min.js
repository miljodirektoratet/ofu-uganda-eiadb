angular.module('seroApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('partials/directives.deleteButton.html',
    "<div class=btn-group dropdown auto-close=disabled is-open=button.isopen><button ng-if=warning type=button class=\"btn btn-sm btn-delete\" ng-class=buttonClass dropdown-toggle>{{text}}</button> <button ng-if=!warning type=button class=\"btn btn-sm btn-delete\" ng-class=buttonClass ng-click=onYes();>{{text}}</button><ul class=dropdown-menu role=menu><li role=menuitem><div class=row><div class=col-md-12>{{warning}}</div></div><div class=row><div class=\"col-md-4 col-md-offset-2\"><button type=button class=\"btn btn-sm btn-primary\" ng-click=\"onYes();button.isopen = false;\">OK</button></div><div class=col-md-6><button type=button class=\"btn btn-sm btn-warning\" ng-click=\"button.isopen = false\">Cancel</button></div></div></li></ul></div>"
  );
  ...
  $templateCache.put('partials/searchTabs.html',
    "<div class=search><ul class=\"nav nav-tabs\" role=tablist><li ng-class=\"{active: tab==SearchTabEnum.Projects}\"><a ng-href=#/search/projects>Project</a></li><li ng-class=\"{active: tab==SearchTabEnum.AuditsInspections}\"><a href=#/search/auditsinspections>Audit and Inspection</a></li></ul><div ng-if=\"tab==SearchTabEnum.Projects\"><div ng-controller=SearchProjectsController ng-include=\"'partials/searchProjects.html'\"></div></div><div ng-if=\"tab==SearchTabEnum.EiasPermits\">NOT IMPLEMENTED</div><div ng-if=\"tab==SearchTabEnum.AuditsInspections\"><div ng-controller=SearchAuditsInspectionsController ng-include=\"'partials/searchAuditsInspections.html'\"></div></div></div>"
  );

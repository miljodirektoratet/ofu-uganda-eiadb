...
controllers.controller("PractitionersController", [
  ...
  function (scope, filter, animate, UserInfo, Practitioner, Valuelists) {
    ...
    scope.exportPractitioners = function (practitioners) {
      ...
      var certificateList = [];
      var numberOfPractitioners = practitionerList.length;
      for (var i = 0; i < numberOfPractitioners; i++) {
        var practitioner = practitionerList[i];
      ...
      exportObj.exportData(certificateList, "practitioners");
    };

...
controllers.controller('SearchEiasPermitsController', ['$scope', '$routeParams', '$location', '$q', '$timeout', 'EiaPermitSearch', 'UserInfo', 'Valuelists', 'EiaPermitSearchService', function (scope, routeParams, location, $q, $timeout, EiaPermitSearch, UserInfo, Valuelists, EiaPermitSearchService)
{
    ...
    scope.gridOptions.appScopeProvider = {
        ...
        {
            scope.goto("/projects/" + rowEntity.project_id + "/eiaspermits/" + rowEntity.eiapermit_id);
    ...
    {
        scope.dateCriteria.eiapermit_date_submission_from = new Date(scope.criteria.eiapermit_date_submission_from);
    }
    if (scope.criteria.eiapermit_date_submission_to)
    {
        scope.dateCriteria.eiapermit_date_submission_to = new Date(scope.criteria.eiapermit_date_submission_to);
    }

    if (_.isEmpty(scope.criteria) && !_.isEmpty(EiaPermitSearchService.criteria))
    {

...
services.factory('Hearing', ['$resource', function ($resource)
{
    return $resource('/api/v1/project/:projectId/eiapermit/:eiapermitId/document/:documentId/hearing/:hearingId', {hearingId: '@id'},
        {
            'update': {method: 'PUT', isArray: false}
        });
}]);
...
services.factory('EiaPermitSearchService', ['EiaPermitSearch', '$q', function (EiaPermitSearch, $q)
{
    var factory = {};
    factory.criteria = {};
...
services.factory('ExternalAuditSearchService', ['ExternalAuditSearch', '$q', function (ExternalAuditSearch, $q)
{
    var factory = {};
    factory.criteria = {};
    factory.allowCache = true;

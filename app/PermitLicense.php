...
class PermitLicense extends Model
{
    ...
    public function documentation()
    {
        ...
        return $this->belongsToMany('App\FileMetadata', 'permits_licenses_documentation')->select(
            '*',
